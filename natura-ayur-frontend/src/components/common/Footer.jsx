    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand and About */}
          <div>
            <h2 className="text-2xl font-bold text-green-500 mb-4">NaturaAyur</h2>
            <p className="text-gray-300 mb-4">
              Discover the ancient wisdom of Ayurveda with our premium collection of natural products
              for holistic wellbeing and balanced living.
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} NaturaAyur. All rights reserved.
          </p>
